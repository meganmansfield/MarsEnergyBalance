...
for n=[1,2,3,4,5,6,7,8]
    ...
    %load(strcat('insolationsloped',num2str(n),'.dmat')); %sloped surface at 20 latitude
    %load(strcat('insolationsloped',num2str(n),'.tmat'));
    %load(strcat('insolationsloped',num2str(n),'.othermat'));
    %load(strcat('insolation40sloped',num2str(n),'.dflatmat')); %surface at 40 latitude
    %load(strcat('insolation40sloped',num2str(n),'.deqmat'));
    %load(strcat('insolation40sloped',num2str(n),'.dpolemat'));
    %iDnet=[iDnetpole,iDnetflat,iDneteq];
    %load(strcat('insolation40sloped',num2str(n),'.tmat'));
    %load(strcat('insolation40sloped',num2str(n),'.othermat'));
    ...
    save('MavenT',num2str(n),'.mat','netforceD','timetotoday','timesunform','obl'); %flat surface at equator or 20 latitude
    %save('MavenslopedT',num2str(n),'.mat','netforceD','timetotoday','timesunform','obl'); %sloped surface at 20 latitude
    %save('Maven40slopedT',num2str(n),'.mat','netforceD','timetotoday','timesunform','obl'); %surface at 40 latitude
